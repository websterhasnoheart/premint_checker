...
-  **As premint is busting their ass to eliminate premint bots, this repo will stop updating itself, but a more advanced version of premint checker with proxy support is coming soon.**
## 1. Requirement
